...
str Cellfile = "fb_inhib.p"  // name of the excitatory cell parameter file

str Cell_name = "feedback_cell"   // name of the excitatory cell
...
make_Nagraph
addmsg /{Cell_name}/soma/fb_Na /dataNa/current PLOT Ik *ampere *black

make_Kdrgraph
addmsg /{Cell_name}/soma/fb_Kdr /dataKdr/current PLOT Ik *ampere *black

make_Kagraph
addmsg /{Cell_name}/soma/fb_Ka /dataKa/current PLOT Ik *ampere *black
