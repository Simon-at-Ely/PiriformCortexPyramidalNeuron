...
echo "    Simulation reference: Sim_3"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_3/Pyramidal_Neuron_original_test.p /cells/CellGroup_3/CellGroup_3_0
...
position /cells/CellGroup_3/CellGroup_3_0 9.860744E-5 1.402765E-5 2.067493E-5
...
//   Adding a current pulse of amplitude: 1.0E-9 A, SingleElectricalInput: [Input: IClamp, cellGroup: CellGroup_3, cellNumber: 0, segmentId: 14, fractionAlong: 0.5]

//   Pulses are shifted one dt step, so that pulse will begin at delay1, as in NEURON

setfield ^ level1 0.7E-7 width1 5.0E-4 delay1 0.049975 delay2 10000.0  
...
create xform /plots/CellGroup_3_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_3/CellGroup_3_0: Sim_3"
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_3"
...
echo Starting sim: Sim_3 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_3
date +%F__%T__%N
