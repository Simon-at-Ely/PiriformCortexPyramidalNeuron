...
echo "    Simulation reference: Sim_27"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_27/Pyramidal_Neuron_original_soma.p /cells/CellGroup_2/CellGroup_2_0
...
position /cells/CellGroup_2/CellGroup_2_0 7.740096E-5 9.210709E-6 1.982946E-5
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_27/Pyramidal_Neuron_ChannelML_soma.p /cells/CellGroup_4/CellGroup_4_0
...
position /cells/CellGroup_4/CellGroup_4_0 1.309293E-5 6.350556E-6 2.869988E-5
...
create xform /plots/CellGroup_2_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_4/CellGroup_4_0: Sim_27"
...
create xform /plots/GraphWin_2 [500,100,400,400]  -title "Values of Na_Hippo_ChannelML:h (Y) in /cells/CellGroup_4/CellGroup_4_0: Sim_27"
...
create xform /plots/GraphWin_1 [500,100,400,400]  -title "Values of Na_Hippo_ChannelML:m (X) in /cells/CellGroup_4/CellGroup_4_0: Sim_27"
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_27"
...
echo Starting sim: Sim_27 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_27
date +%F__%T__%N
