...
echo "    Simulation reference: Sim_15"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_15/Pyramidal_Neuron_original_test.p /cells/CellGroup_3/CellGroup_3_0
...
create xform /plots/CellGroup_3_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_3/CellGroup_3_0: Sim_15"
...
create xform /plots/GraphWin_0 [500,100,400,400]  -title "Values of Ca_buffer:CONC:ca (Ca) in /cells/CellGroup_3/CellGroup_3_0: Sim_15"
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_15"
...
echo Starting sim: Sim_15 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_15
date +%F__%T__%N
