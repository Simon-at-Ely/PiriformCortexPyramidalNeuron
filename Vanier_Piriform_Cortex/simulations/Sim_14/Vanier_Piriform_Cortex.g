...
echo "    Simulation reference: Sim_14"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_14/Pyramidal_Neuron_original_test.p /cells/CellGroup_3/CellGroup_3_0
...
position /cells/CellGroup_3/CellGroup_3_0 6.286156E-5 9.996473E-6 7.173622E-6
...
create xform /plots/CellGroup_3_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_3/CellGroup_3_0: Sim_14"
...
create xform /plots/GraphWin_0 [500,100,400,400]  -title "Values of Ca_buffer:CONC:ca (Ca) in /cells/CellGroup_3/CellGroup_3_0: Sim_14"
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_14"
...
echo Starting sim: Sim_14 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_14
date +%F__%T__%N
