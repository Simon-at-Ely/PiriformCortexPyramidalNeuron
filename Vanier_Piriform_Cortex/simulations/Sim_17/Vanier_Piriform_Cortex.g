...
echo "    Simulation reference: Sim_17"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_17/Pyramidal_Neuron_original_test.p /cells/CellGroup_3/CellGroup_3_0
...
position /cells/CellGroup_3/CellGroup_3_0 3.266114E-5 1.278742E-5 3.411062E-5
...
create xform /plots/CellGroup_3_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_3/CellGroup_3_0: Sim_17"
...
create xform /plots/GraphWin_0 [500,100,400,400]  -title "Values of Ca_buffer:CONC:ca (Ca) in /cells/CellGroup_3/CellGroup_3_0: Sim_17"
xshow /plots/GraphWin_0
create xgraph /plots/GraphWin_0/graph -xmin 0 -xmax {duration} -ymin 0.0 -ymax 1.0E31
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_17"
...
echo Starting sim: Sim_17 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_17
date +%F__%T__%N
