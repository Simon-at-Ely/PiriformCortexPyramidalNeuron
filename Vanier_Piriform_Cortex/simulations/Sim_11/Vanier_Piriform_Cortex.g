...
echo "    Simulation reference: Sim_11"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_11/Pyramidal_Neuron_original_test.p /cells/CellGroup_3/CellGroup_3_0
...
position /cells/CellGroup_3/CellGroup_3_0 7.908405E-5 1.187198E-5 2.703531E-5
...
create xform /plots/CellGroup_3_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_3/CellGroup_3_0: Sim_11"
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_11"
...
echo Starting sim: Sim_11 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_11
date +%F__%T__%N
