...
echo "    Simulation reference: Sim_4"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_4/Pyramidal_Neuron_original_test.p /cells/CellGroup_3/CellGroup_3_0
...
position /cells/CellGroup_3/CellGroup_3_0 9.683578E-5 1.370214E-5 9.25984E-5
...
//   Adding a current pulse of amplitude: 1.0E-5 A, SingleElectricalInput: [Input: IClamp, cellGroup: CellGroup_3, cellNumber: 0, segmentId: 14, fractionAlong: 0.5]

//   Pulses are shifted one dt step, so that pulse will begin at delay1, as in NEURON

setfield ^ level1 0.8E-7 width1 5.0E-4 delay1 0.049975 delay2 10000.0  
...
create xform /plots/CellGroup_3_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_3/CellGroup_3_0: Sim_4"
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_4"
...
echo Starting sim: Sim_4 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_4
date +%F__%T__%N
