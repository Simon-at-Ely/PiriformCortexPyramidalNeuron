...
echo "    Simulation reference: Sim_12"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_12/Pyramidal_Neuron_original_test.p /cells/CellGroup_3/CellGroup_3_0
...
position /cells/CellGroup_3/CellGroup_3_0 9.734372E-5 7.522202E-6 2.47513E-5
...
create xform /plots/CellGroup_3_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_3/CellGroup_3_0: Sim_12"
...
create xform /plots/GraphWin_0 [500,100,400,400]  -title "Values of Ca_buffer:CONC:ca (Ca) in /cells/CellGroup_3/CellGroup_3_0: Sim_12"
xshow /plots/GraphWin_0
create xgraph /plots/GraphWin_0/graph -xmin 0 -xmax {duration} -ymin 0.0 -ymax 9.9999998E17
addmsg /cells/CellGroup_3/CellGroup_3_0/Soma/Ca_buffer /plots/GraphWin_0/graph PLOT Ca *...oup_3_0/Soma_Ca_buffer:Ca *black
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_12"
...
//   Saving Ca_buffer:CONC:ca on only one seg, id: 0, in only cell: 0 in CellGroup_3

if (!{exists /fileout/cells/CellGroup_3})
    create neutral /fileout/cells/CellGroup_3
end

//   Recording cell: /cells/CellGroup_3/CellGroup_3_0

cellName = "/cells/CellGroup_3/CellGroup_3_0"
    if (!{exists /fileout{cellName}})
        create neutral /fileout{cellName}
    end
...
setfield /fileout{compName}Ca_buffer_CONC_ca filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_3/CellGroup_3_0/Soma/Ca_buffer /fileout{compName}Ca_buffer_CONC_ca SAVE Ca
call /fileout{compName}Ca_buffer_CONC_ca OUT_OPEN
call /fileout{compName}Ca_buffer_CONC_ca OUT_WRITE {getfield /cells/CellGroup_3/CellGroup_3_0/Soma/Ca_buffer Ca}
...
echo Starting sim: Sim_12 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_12
date +%F__%T__%N
