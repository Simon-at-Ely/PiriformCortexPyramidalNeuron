...
echo "    Simulation reference: Sim_16"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_16/Pyramidal_Neuron_original_test.p /cells/CellGroup_3/CellGroup_3_0
...
position /cells/CellGroup_3/CellGroup_3_0 7.189523E-5 8.557868E-6 8.757053E-5
...
create xform /plots/CellGroup_3_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_3/CellGroup_3_0: Sim_16"
...
create xform /plots/GraphWin_0 [500,100,400,400]  -title "Values of Ca_buffer:CONC:ca (Ca) in /cells/CellGroup_3/CellGroup_3_0: Sim_16"
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_16"
...
echo Starting sim: Sim_16 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_16
date +%F__%T__%N
