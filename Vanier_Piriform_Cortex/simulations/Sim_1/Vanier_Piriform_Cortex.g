...
echo "    Simulation reference: Sim_1"
echo " "
echo  "*****************************************************"
...
//////////////////////////////////////////////////////////////////////
//   Cell group 0: CellGroup_1 has cells of type: Pyramidal_Neuron_original
//////////////////////////////////////////////////////////////////////


create neutral /cells/CellGroup_1
//   Adding cells of type Pyramidal_Neuron_original in region Regions_1
...
readcell /home/Simon/nC_projects/Vanier_Piriform_Cortex/simulations/Sim_1/Pyramidal_Neuron_original.p /cells/CellGroup_1/CellGroup_1_0
addfield /cells/CellGroup_1/CellGroup_1_0 celltype
setfield /cells/CellGroup_1/CellGroup_1_0 celltype Pyramidal_Neuron_original

position /cells/CellGroup_1/CellGroup_1_0 8.302292E-5 1.246297E-5 6.773116E-5
...
//   Adding a current pulse of amplitude: 1.0E-9 A, SingleElectricalInput: [Input: IClamp, cellGroup: CellGroup_1, cellNumber: 0, segmentId: 14, fractionAlong: 0.5]

//   Pulses are shifted one dt step, so that pulse will begin at delay1, as in NEURON

setfield ^ level1 20.0E-9 width1 5.0E-4 delay1 0.049975 delay2 10000.0  
addmsg /stim/pulse/stim_Input_0_CellGroup_1_0 /cells/CellGroup_1/CellGroup_1_0/D1b2__Extra_11 INJECT output
...
create xform /plots/CellGroup_1_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_1/CellGroup_1_0: Sim_1"
xshow /plots/CellGroup_1_v
create xgraph /plots/CellGroup_1_v/graph -xmin 0 -xmax {duration} -ymin -0.09 -ymax 0.05
addmsg /cells/CellGroup_1/CellGroup_1_0/Soma /plots/CellGroup_1_v/graph PLOT Vm *...p_1/CellGroup_1_0_Soma:Vm *black
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_1"
...
echo Starting sim: Sim_1 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_1
date +%F__%T__%N
