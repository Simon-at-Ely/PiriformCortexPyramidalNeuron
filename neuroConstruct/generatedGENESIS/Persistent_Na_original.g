...
// Persistent_Na_original (Type: Channel mechanism, Model: File Based Membrane Mechanism)
...
function make_Persistent_Na_original
	str chanpath = "/library/Persistent_Na_original"
	if ({exists {chanpath}})
	    return
	end
