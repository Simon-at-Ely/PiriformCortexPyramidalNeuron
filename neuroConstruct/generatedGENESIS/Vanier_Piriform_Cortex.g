...
echo "    Simulation reference: Sim_139"
echo " "
echo  "*****************************************************"
...
readcell /home/Simon/PiriformCortexPyramidalNeuron/neuroConstruct/simulations/Sim_139/Pyramidal_Neuron_original_soma.p /cells/CellGroup_2/CellGroup_2_0
...
position /cells/CellGroup_2/CellGroup_2_0 7.301781E-6 1.661405E-5 1.774353E-5
...
readcell /home/Simon/PiriformCortexPyramidalNeuron/neuroConstruct/simulations/Sim_139/Pyramidal_Neuron_ChannelML_soma.p /cells/CellGroup_4/CellGroup_4_0
...
position /cells/CellGroup_4/CellGroup_4_0 7.255999E-5 2.009965E-5 1.073864E-4
...
create xform /plots/CellGroup_2_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_2/CellGroup_2_0: Sim_139"
...
create xform /plots/GraphWin_1 [500,100,400,400]  -title "Values of Na_Hipo_original:X (X) in /cells/CellGroup_2/CellGroup_2_0: Sim_139"
...
addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Piriform_KA_ChannelML /plots/GraphWin_1/graph PLOT Y *...a_Piriform_KA_ChannelML:Y *red
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Persistent_Na_original /plots/GraphWin_1/graph PLOT X *..._Persistent_Na_original:X *blue
addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Persistent_Na_ChannelML /plots/GraphWin_1/graph PLOT X *...Persistent_Na_ChannelML:X *green
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Olfactory_Ca /plots/GraphWin_1/graph PLOT X *...p_2_0/Soma_Olfactory_Ca:X *orange
addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Olfactory_Ca_ChannelML /plots/GraphWin_1/graph PLOT X *..._Olfactory_Ca_ChannelML:X *brown
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Olfactory_Ca /plots/GraphWin_1/graph PLOT Y *...p_2_0/Soma_Olfactory_Ca:Y *magenta
addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Olfactory_Ca_ChannelML /plots/GraphWin_1/graph PLOT Y *..._Olfactory_Ca_ChannelML:Y *yellow
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Noninactivating_Muscarinic_K /plots/GraphWin_1/graph PLOT X *...activating_Muscarinic_K:X *grey
addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Km_ChannelML /plots/GraphWin_1/graph PLOT X *...p_4_0/Soma_Km_ChannelML:X *black
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/KCa_1 /plots/GraphWin_1/graph PLOT Z *...ellGroup_2_0/Soma_KCa_1:Z *red
...
create xform /plots/GraphWin_3 [500,100,400,400]  -title "Values of Ca_buffer:CONC:ca (Ca) in /cells/CellGroup_2/CellGroup_2_0: Sim_139"
...
addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Kahp2_ChannelML /plots/GraphWin_1/graph PLOT Z *..._0/Soma_Kahp2_ChannelML:Z *brown
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Na_Hipo_original /plots/GraphWin_1/graph PLOT Y *...0/Soma_Na_Hipo_original:Y *magenta
addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Na_Hippo_ChannelML /plots/GraphWin_1/graph PLOT Y *...Soma_Na_Hippo_ChannelML:Y *yellow
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/KDR_Hipo_original /plots/GraphWin_1/graph PLOT X *.../Soma_KDR_Hipo_original:X *grey
addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/KDR_Hippo_ChannelML /plots/GraphWin_1/graph PLOT X *...oma_KDR_Hippo_ChannelML:X *black
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Piriform_KA_original /plots/GraphWin_1/graph PLOT X *...ma_Piriform_KA_original:X *red
addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Piriform_KA_ChannelML /plots/GraphWin_1/graph PLOT X *...a_Piriform_KA_ChannelML:X *blue
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Piriform_KA_original /plots/GraphWin_1/graph PLOT Y *...ma_Piriform_KA_original:Y *green
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_139"
...
//   Saving Persistent_Na_original:X on only one seg, id: 0, in only cell: 0 in CellGroup_2
...
compName = {strcat {cellName} /Soma}
str fileNameStr
fileNameStr = {strcat {getpath {cellName} -tail} {".Persistent_Na_original_X.dat"} }
create asc_file /fileout{compName}Persistent_Na_original_X
setfield /fileout{compName}Persistent_Na_original_X    flush 1    leave_open 1    append 1 notime 1
setfield /fileout{compName}Persistent_Na_original_X filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Persistent_Na_original /fileout{compName}Persistent_Na_original_X SAVE X
call /fileout{compName}Persistent_Na_original_X OUT_OPEN
call /fileout{compName}Persistent_Na_original_X OUT_WRITE {getfield /cells/CellGroup_2/CellGroup_2_0/Soma/Persistent_Na_original X}

//   Saving Persistent_Na_ChannelML:m on only one seg, id: 0, in only cell: 0 in CellGroup_4
...
compName = {strcat {cellName} /Soma}
str fileNameStr
fileNameStr = {strcat {getpath {cellName} -tail} {".Persistent_Na_ChannelML_m.dat"} }
create asc_file /fileout{compName}Persistent_Na_ChannelML_m
setfield /fileout{compName}Persistent_Na_ChannelML_m    flush 1    leave_open 1    append 1 notime 1
setfield /fileout{compName}Persistent_Na_ChannelML_m filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Persistent_Na_ChannelML /fileout{compName}Persistent_Na_ChannelML_m SAVE X
call /fileout{compName}Persistent_Na_ChannelML_m OUT_OPEN
call /fileout{compName}Persistent_Na_ChannelML_m OUT_WRITE {getfield /cells/CellGroup_4/CellGroup_4_0/Soma/Persistent_Na_ChannelML X}
...
//   Saving Noninactivating_Muscarinic_K:X on only one seg, id: 0, in only cell: 0 in CellGroup_2
...
compName = {strcat {cellName} /Soma}
str fileNameStr
fileNameStr = {strcat {getpath {cellName} -tail} {".Noninactivating_Muscarinic_K_X.dat"} }
create asc_file /fileout{compName}Noninactivating_Muscarinic_K_X
setfield /fileout{compName}Noninactivating_Muscarinic_K_X    flush 1    leave_open 1    append 1 notime 1
setfield /fileout{compName}Noninactivating_Muscarinic_K_X filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Noninactivating_Muscarinic_K /fileout{compName}Noninactivating_Muscarinic_K_X SAVE X
call /fileout{compName}Noninactivating_Muscarinic_K_X OUT_OPEN
call /fileout{compName}Noninactivating_Muscarinic_K_X OUT_WRITE {getfield /cells/CellGroup_2/CellGroup_2_0/Soma/Noninactivating_Muscarinic_K X}

//   Saving Km_ChannelML:m on only one seg, id: 0, in only cell: 0 in CellGroup_4
...
compName = {strcat {cellName} /Soma}
str fileNameStr
fileNameStr = {strcat {getpath {cellName} -tail} {".Km_ChannelML_m.dat"} }
create asc_file /fileout{compName}Km_ChannelML_m
setfield /fileout{compName}Km_ChannelML_m    flush 1    leave_open 1    append 1 notime 1
setfield /fileout{compName}Km_ChannelML_m filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Km_ChannelML /fileout{compName}Km_ChannelML_m SAVE X
call /fileout{compName}Km_ChannelML_m OUT_OPEN
call /fileout{compName}Km_ChannelML_m OUT_WRITE {getfield /cells/CellGroup_4/CellGroup_4_0/Soma/Km_ChannelML X}

//   Saving KCa_1:Z on only one seg, id: 0, in only cell: 0 in CellGroup_2
...
setfield /fileout{compName}KCa_1_Z filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/KCa_1 /fileout{compName}KCa_1_Z SAVE Z
call /fileout{compName}KCa_1_Z OUT_OPEN
call /fileout{compName}KCa_1_Z OUT_WRITE {getfield /cells/CellGroup_2/CellGroup_2_0/Soma/KCa_1 Z}
...
//   Saving Kahp1_ChannelML:Z on only one seg, id: 0, in only cell: 0 in CellGroup_4
...
setfield /fileout{compName}Kahp1_ChannelML_Z filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Kahp1_ChannelML /fileout{compName}Kahp1_ChannelML_Z SAVE Z
call /fileout{compName}Kahp1_ChannelML_Z OUT_OPEN
call /fileout{compName}Kahp1_ChannelML_Z OUT_WRITE {getfield /cells/CellGroup_4/CellGroup_4_0/Soma/Kahp1_ChannelML Z}

//   Saving Ca_buffer:CONC:ca on only one seg, id: 0, in only cell: 0 in CellGroup_2
...
setfield /fileout{compName}Ca_buffer_CONC_ca filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Ca_buffer /fileout{compName}Ca_buffer_CONC_ca SAVE Ca
call /fileout{compName}Ca_buffer_CONC_ca OUT_OPEN
call /fileout{compName}Ca_buffer_CONC_ca OUT_WRITE {getfield /cells/CellGroup_2/CellGroup_2_0/Soma/Ca_buffer Ca}

//   Saving Ca_buffer_ChannelML:CONC:ca on only one seg, id: 0, in only cell: 0 in CellGroup_4
...
setfield /fileout{compName}Ca_buffer_ChannelML_CONC_ca filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Ca_buffer_ChannelML /fileout{compName}Ca_buffer_ChannelML_CONC_ca SAVE Ca
call /fileout{compName}Ca_buffer_ChannelML_CONC_ca OUT_OPEN
call /fileout{compName}Ca_buffer_ChannelML_CONC_ca OUT_WRITE {getfield /cells/CellGroup_4/CellGroup_4_0/Soma/Ca_buffer_ChannelML Ca}

//   Saving KCa_2:Z on only one seg, id: 0, in only cell: 0 in CellGroup_2
...
compName = {strcat {cellName} /Soma}
str fileNameStr
fileNameStr = {strcat {getpath {cellName} -tail} {".KCa_2_Z.dat"} }
create asc_file /fileout{compName}KCa_2_Z
setfield /fileout{compName}KCa_2_Z    flush 1    leave_open 1    append 1 notime 1
setfield /fileout{compName}KCa_2_Z filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/KCa_2 /fileout{compName}KCa_2_Z SAVE Z
call /fileout{compName}KCa_2_Z OUT_OPEN
call /fileout{compName}KCa_2_Z OUT_WRITE {getfield /cells/CellGroup_2/CellGroup_2_0/Soma/KCa_2 Z}

//   Saving Kahp2_ChannelML:Z on only one seg, id: 0, in only cell: 0 in CellGroup_4
...
compName = {strcat {cellName} /Soma}
str fileNameStr
fileNameStr = {strcat {getpath {cellName} -tail} {".Kahp2_ChannelML_Z.dat"} }
create asc_file /fileout{compName}Kahp2_ChannelML_Z
setfield /fileout{compName}Kahp2_ChannelML_Z    flush 1    leave_open 1    append 1 notime 1
setfield /fileout{compName}Kahp2_ChannelML_Z filename { strcat  {targetDir} {fileNameStr}}
    addmsg /cells/CellGroup_4/CellGroup_4_0/Soma/Kahp2_ChannelML /fileout{compName}Kahp2_ChannelML_Z SAVE Z
call /fileout{compName}Kahp2_ChannelML_Z OUT_OPEN
call /fileout{compName}Kahp2_ChannelML_Z OUT_WRITE {getfield /cells/CellGroup_4/CellGroup_4_0/Soma/Kahp2_ChannelML Z}
...
echo Starting sim: Sim_139 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_139
date +%F__%T__%N
