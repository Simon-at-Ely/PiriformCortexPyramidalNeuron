...
echo "    for project: /home/padraig/PiriformCortexPyramidalNeuron/neuroConstruct/Vanier_Piriform_Cortex.ncx"
echo ""
echo "    Description: "

echo "    Simulation configuration: AllWorkingChannels"
echo "    Simulation reference: Sim_60"
echo " "
echo  "*****************************************************"
...
readcell /home/padraig/PiriformCortexPyramidalNeuron/neuroConstruct/simulations/Sim_60/Pyramidal_Neuron_original_soma.p /cells/CellGroup_2/CellGroup_2_0
...
position /cells/CellGroup_2/CellGroup_2_0 5.231425E-5 2.010792E-5 3.750349E-5
...
create xform /plots/CellGroup_2_v [500,100,400,400]  -title "Values of VOLTAGE (Vm) in /cells/CellGroup_2/CellGroup_2_0: Sim_60"
...
create xform /plots/GraphWin_1 [500,100,400,400]  -title "Values of Na_Hipo_original:X (X) in /cells/CellGroup_2/CellGroup_2_0: Sim_60"
...
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Olfactory_Ca /plots/GraphWin_1/graph PLOT X *...p_2_0/Soma_Olfactory_Ca:X *red
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Olfactory_Ca /plots/GraphWin_1/graph PLOT Y *...p_2_0/Soma_Olfactory_Ca:Y *blue
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Na_Hipo_original /plots/GraphWin_1/graph PLOT Y *...0/Soma_Na_Hipo_original:Y *green
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/KDR_Hipo_original /plots/GraphWin_1/graph PLOT X *.../Soma_KDR_Hipo_original:X *orange
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Piriform_KA_original /plots/GraphWin_1/graph PLOT X *...ma_Piriform_KA_original:X *brown
addmsg /cells/CellGroup_2/CellGroup_2_0/Soma/Piriform_KA_original /plots/GraphWin_1/graph PLOT Y *...ma_Piriform_KA_original:Y *magenta
...
create xform /controls/runControl [700, 20, 200, 140] -title "Run Controls: Sim_60"
...
reset
str simsDir
simsDir = "/home/padraig/PiriformCortexPyramidalNeuron/neuroConstruct/simulations/"
...
echo Starting sim: Sim_60 on {genesisCore} with dur: {duration} dt: {dt} and steps: {steps} (Crank-Nicholson num integration method (11), using hsolve: true, chanmode: 0)
date +%F__%T__%N
step {steps}

echo Finished simulation reference: Sim_60
date +%F__%T__%N
