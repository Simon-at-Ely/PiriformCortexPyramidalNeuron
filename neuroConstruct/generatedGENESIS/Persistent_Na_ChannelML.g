...
// /channelml/channel_type/current_voltage_relation/gate/time_course/@expr = 1.0 / (91000 * (v + 0.048)/ (1.0 - (exp ((-1.0 * 0.048 - v)/ 0.005))) + (-1.0 * 62000) * (v + 0.048)/ (1.0 - (exp ((v + 0.048)/ 0.005)))) 
...
Reference: D.A. McCormick and J.R. Huguenard. A model of the electrophysiological properties of thalamocortical relay neurons. Journal of Neurophysiology 68, 1384-1399
        ...
        */
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            // Found a generic form of rate equation for tau, using expression: 1.0 / (91000 * (v + 0.048)/ (1.0 - (exp ((-1.0 * 0.048 - v)/ 0.005))) + (-1.0 * 62000) * (v + 0.048)/ (1.0 - (exp ((v + 0.048)/ 0.005))))
