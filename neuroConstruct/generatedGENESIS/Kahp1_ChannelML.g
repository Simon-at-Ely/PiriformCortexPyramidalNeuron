...
// /channelml/channel_type/current_voltage_relation/gate/transition[1]/@expr = if (ca_conc &lt; 0.0001 ? 10.0 * ca_conc/ 8.2e-06 : 10.0 
...
// /channelml/channel_type/current_voltage_relation/gate/transition[2]/@expr = ca_conc &lt; 0.0001 ? (10.0 * ca_conc/ 8.2e-06) + 0.5 : 10.0 
...
Reference: M. C. Vanier and J. M. Bower, A Comparative Survey of Automated Parameter-Searching Methods for Compartmental Neural Models, .
        ...
        */
        ...
        for (c = 0; c <= ({tab_divs}); c = c + 1)
            ...
            // Found a generic form of rate equation for beta, using expression: ca_conc < 4.2e-06 ? (10.0 * ca_conc/ 8.2e-06) + 0.5 : 10.5
            // Will translate this for GENESIS compatibility...
                    

            if (ca_conc < 4.2e-06 )
                beta =  {10.0 * ca_conc/ 8.2e-06} + 0.5 
            else
                beta =  10.5
            end
